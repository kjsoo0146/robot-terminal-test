...
#define S_FUNCTION_NAME                CTM_disturb_cgxe
#include "simstruc.h"
#include "CTM_disturb_cgxe.h"
#define MDL_START

static void mdlStart(SimStruct* S)
{
  unsigned int success;
  success = cgxe_CTM_disturb_method_dispatcher(S, SS_CALL_MDL_START, NULL);
  if (!success) {
    /* error */
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 3579482228;
    checksumData[1] = 293596960;
    checksumData[2] = 1873473605;
    checksumData[3] = 1720488016;
...

  {
    ...
    checksumData[0] = 1187575211;
    checksumData[1] = 1757716649;
    checksumData[2] = 3253980411;
    checksumData[3] = 1606410561;
...

  {
    ...
    checksumData[0] = 82745544;
    checksumData[1] = 1985519590;
    checksumData[2] = 2007724172;
    checksumData[3] = 1571990342;
  ...
  mxArray * prhs[])
{
  ...
  success = cgxe_CTM_disturb_method_dispatcher(S, SS_CALL_MDL_GET_SIM_STATE,
    (void *) (plhs));
  if (!success) {
    /* error */
    mexPrintf("ERROR: Failed to dispatch s-function method!\n");
  ...
  mxArray * prhs[])
{
  unsigned int success;
  SimStruct *S = cgxe_unpack_simstruct(prhs[1]);
  success = cgxe_CTM_disturb_method_dispatcher(S, SS_CALL_MDL_SET_SIM_STATE,
    (void *) prhs[2]);
  if (!success) {
    /* error */
    mexPrintf("ERROR: Failed to dispatch s-function method!\n");
