  ...
  * data)
{
  ...
  if (ssGetChecksum0(S) == 930671309 &&
      ssGetChecksum1(S) == 480553441 &&
      ssGetChecksum2(S) == 2083317479 &&
      ssGetChecksum3(S) == 4079338517) {
    method_dispatcher_G0TGdfWLU7lDoL4R3O6AXE(S, method, data);
    return 1;
  }
