#ifndef __FAU8KyrDQYUp9atreb3T4G_h__
#define __FAU8KyrDQYUp9atreb3T4G_h__
...
#ifndef struct_tag_6RQ9JqIxNyLwYE4vMpqC8B
#define struct_tag_6RQ9JqIxNyLwYE4vMpqC8B

struct tag_6RQ9JqIxNyLwYE4vMpqC8B
{
  boolean_T matlabCodegenIsDeleted;
  real_T NumBodies;
...
#endif                                 /* struct_tag_6RQ9JqIxNyLwYE4vMpqC8B */

#ifndef typedef_robotics_manip_internal_RigidBodyTree
#define typedef_robotics_manip_internal_RigidBodyTree

typedef struct tag_6RQ9JqIxNyLwYE4vMpqC8B robotics_manip_internal_RigidBodyTree;

#endif                                 /* typedef_robotics_manip_internal_RigidBodyTree */

#ifndef struct_tag_elDV6B0VfVUWgvOdkWltQG
#define struct_tag_elDV6B0VfVUWgvOdkWltQG

struct tag_elDV6B0VfVUWgvOdkWltQG
{
  boolean_T matlabCodegenIsDeleted;
...
#endif                                 /* struct_tag_elDV6B0VfVUWgvOdkWltQG */
...
typedef struct tag_elDV6B0VfVUWgvOdkWltQG
...
#ifndef typedef_InstanceStruct_FAU8KyrDQYUp9atreb3T4G
#define typedef_InstanceStruct_FAU8KyrDQYUp9atreb3T4G
...
#endif                                 /* typedef_InstanceStruct_FAU8KyrDQYUp9atreb3T4G */
...
extern void method_dispatcher_FAU8KyrDQYUp9atreb3T4G(SimStruct *S, int_T method,
  void* data);
